...
public class H2_1 {
  ...
  public void getRelativeNumberOfCoinsUseMaterialized() {
  ...
  public void overridePutPickTest() {
    ...
    try {
      Method m = RobotWithInitialState2.class.getMethod("putCoin");
    ...
    try {
      Method m = RobotWithInitialState2.class.getMethod("pickCoin");
